...
def ensure_session_exists(session_id: str, results_folder: str = None) -> Tuple[str, Dict[str, Any]]:
    """
    ...
    for session_folder in os.listdir(results_folder):
        ...
        if os.path.isdir(session_path):
            try:
                ...
                logger.warning(f"Failed to load metadata for session {session_folder}: {e}")
