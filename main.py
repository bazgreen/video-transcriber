...
from src.routes import main_bp, api_bp, register_socket_handlers
from src.routes.api import init_api_globals
from src.routes.socket_handlers import init_socket_globals
from src.services import VideoTranscriber, process_upload, delete_session
...
def initialize_managers(socketio: SocketIO) -> Tuple[MemoryManager, ProgressiveFileManager, ProgressTracker]:
    """
